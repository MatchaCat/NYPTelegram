...
class HelpController extends TelegramBaseController {
    ...
    help($) {
        student.retrieve($, function(dollarres){
            console.log('Help condition check: ' + dollarres[1].adminnumber)
            if (dollarres[1].adminnumber == "999999Z" | dollarres[1].adminnumber == null){
                ...
                $.sendMessage('\/help - Get help guides... like this one. Like... legit. this.. haha...' + 
                            ...
                            '\n\/directory - You horny xiao boi boi dun use this find chiobu horh. #hinthint?' + //studentent/Staff directory*
